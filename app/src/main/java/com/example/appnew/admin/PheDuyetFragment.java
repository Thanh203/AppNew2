...
import com.example.appnew.adapter.PheDuyetApdapter;
 ...
 * Use the {@link PheDuyetFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class PheDuyetFragment extends Fragment implements ItemCallback {
     ...
     * @return A new instance of fragment PheDuyetFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static PheDuyetFragment newInstance(String param1, String param2) {
        PheDuyetFragment fragment = new PheDuyetFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_phe_duyet, container, false);

        recyclerView = view.findViewById(R.id.rvTinTucPD);

        lstTinTucs = new ArrayList<>();
        adapter = new PheDuyetApdapter(lstTinTucs ,getActivity(), this);
    ...
    public void onItemClick(String id) {
        Intent intent = new Intent(getActivity(), PheDuyetActivity.class);
