 ...
 * Use the {@link ChuaDuyetFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class ChuaDuyetFragment extends Fragment implements ItemCallback {
     ...
     * @return A new instance of fragment ChuaDuyetFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static ChuaDuyetFragment newInstance(String param1, String param2) {
        ChuaDuyetFragment fragment = new ChuaDuyetFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_chua_duyet, container, false);
        MaterialButton btnTinTucAdd = view.findViewById(R.id.btn_TinTuc_add_cd);
        recyclerView = view.findViewById(R.id.rvTinTucAdmin_cd);
        btnTinTucAdd.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view2) {
                Intent intent = new Intent(getActivity(), ThemTinTucActivity.class);
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            for (QueryDocumentSnapshot document : querySnapshot) {
                                ...
                                if (tinTuc.getTrangThai().equals("Chưa duyệt")) {
